...
export const MeuInput = (props) => (
  <View style={{ flexDirection: 'row', backgroundColor: '#E8E8E8', alignItems: 'center', margin: 5, borderRadius: 25 }}>
    ...
    <StandardInput keyboardAppearance='light' keyboardType='email-address' value={props.value} onChangeText={props.onChangeText} placeholder={props.placeholder} placeholderTextColor='#FFF' selectionColor='#FFF' />
  </View>
);